...
const OUT_NAME = "western_floral_saddle.png";

const SOURCE =
  process.argv[2] ||
  path.join(
    process.env.USERPROFILE || "",
    ".cursor/projects/c-Users-HP-Documents-HourseStore/assets",
    "c__Users_HP_AppData_Roaming_Cursor_User_workspaceStorage_9072ee09493375ac713d431499ab56dc_images_ChatGPT_Image_Sep_14__2026__02_01_15_AM-3f525ccd-adb0-437c-95df-15caa3fb924d.png",
  );

/** Near-black studio backdrop (edge-connected only). */
...
async function main() {
  ...
  console.log(`Wrote ${output} (${side}px cropped → 1024x1024)`);
}
